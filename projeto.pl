...
registrarVenda:- nl,
    ...
    assertz(produto(Nome,Desc,Qvendida)),produto(Nome,Desc,X), Novaquant is X- Qvendida,nl,
...
loginUser:-
    ...
    write("Digite a senha: (FUNC) "), read(Senha),
    if_else(( (User=fam),(Senha=isco)),(menuUser),(nl,write("==================================="),nl,
                                                   write("Dados errados, tente novamente"),nl,
                                                   write("==================================="),nl,nl,loginUser)).
